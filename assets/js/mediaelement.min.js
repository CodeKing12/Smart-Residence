 ...
 *
 * Wrapper that mimics native HTML5 MediaElement (audio and noneo)
...
! function e(t, n, o) {
    ...
    6: [function(e, t, n) {
        ...
        var r = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(e) {
            ...
            p = function e(t, n, o) {
                ...
                ["noneo", "audio"].indexOf(g) > -1 && !m.mediaElement.originalNode.getAttribute("preload") && m.mediaElement.originalNode.setAttribute("preload", "none"), m.mediaElement.originalNode.parentNode.insertBefore(m.mediaElement, m.mediaElement.originalNode), m.mediaElement.appendChild(m.mediaElement.originalNode);
                var y = function(e, t) {
    ...
    7: [function(e, t, n) {
        ...
        i.version = "4.2.7", i.html5media = {
            ...
            mediaTypes: ["audio/mp3", "audio/ogg", "audio/oga", "audio/wav", "audio/x-wav", "audio/wave", "audio/x-pn-wav", "audio/mpeg", "audio/mp4", "noneo/mp4", "noneo/webm", "noneo/ogg", "noneo/ogv"]
            ...
            enterFullScreen: function() {
                ...
                if (!1 === e.options.useFakeFullscreen && d.IS_IOS && d.HAS_IOS_FULLSCREEN && "function" == typeof e.media.originalNode.webkitEnterFullscreen && e.media.originalNode.canPlayType((0, f.getTypeFromFile)(e.media.getSrc()))) e.media.originalNode.webkitEnterFullscreen();
                    ...
                    if ((0, c.addClass)(r.default.documentElement, e.options.classPrefix + "fullscreen"), (0, c.addClass)(e.getElement(e.container), e.options.classPrefix + "container-fullscreen"), e.normalHeight = parseFloat(n.height), e.normalWidth = parseFloat(n.width), "native-native" !== e.fullscreenMode && "plugin-native" !== e.fullscreenMode || (d.requestFullScreen(e.getElement(e.container)), e.isInIframe && setTimeout(function t() {
                        ...
                        for (var o = e.getElement(e.container).querySelectorAll("embed, object, noneo"), a = o.length, s = 0; s < a; s++) o[s].style.width = "100%", o[s].style.height = "100%";
            ...
            exitFullScreen: function() {
                ...
                if (clearTimeout(e.containerSizeTimeout), d.HAS_TRUE_NATIVE_FULLSCREEN && (d.IS_FULLSCREEN || e.isFullScreen) && d.cancelFullScreen(), (0, c.removeClass)(r.default.documentElement, e.options.classPrefix + "fullscreen"), (0, c.removeClass)(e.getElement(e.container), e.options.classPrefix + "container-fullscreen"), e.options.setDimensions) {
                    if (e.getElement(e.container).style.width = e.normalWidth + "px", e.getElement(e.container).style.height = e.normalHeight + "px", t) e.node.style.width = e.normalWidth + "px", e.node.style.height = e.normalHeight + "px";
                        ...
                        for (var n = e.getElement(e.container).querySelectorAll("embed, object, noneo"), o = n.length, i = 0; i < o; i++) n[i].style.width = e.normalWidth + "px", n[i].style.height = e.normalHeight + "px";
            ...
            buildprogress: function(e, t, n, o) {
                ...
                v.className = p.options.classPrefix + "time-rail", v.innerHTML = '<span class="' + p.options.classPrefix + "time-total " + p.options.classPrefix + 'time-slider"><span class="' + p.options.classPrefix + 'time-buffering"></span><span class="' + p.options.classPrefix + 'time-loaded"></span><span class="' + p.options.classPrefix + 'time-current"></span><span class="' + p.options.classPrefix + 'time-hovered no-hover"></span><span class="' + p.options.classPrefix + 'time-handle"><span class="' + p.options.classPrefix + 'time-handle-content"></span></span>' + h + "</span>", p.addControlElement(v, "progress"), p.options.keyActions.push({
                    ...
                    action: function(e) {
                        if (!isNaN(e.duration) && e.duration > 0) {
                            e.isnoneo && (e.showControls(), e.startControlsTimer()), e.getElement(e.container).querySelector("." + r.config.classPrefix + "time-total").focus();
                        ...
                        if (h = t.originalEvent && t.originalEvent.changedTouches ? t.originalEvent.changedTouches[0].pageX : t.changedTouches ? t.changedTouches[0].pageX : t.pageX, p.getDuration()) {
                            if (h < o.left ? h = o.left : h > i + o.left && (h = i + o.left), m = h - o.left, s = m / i, p.newTime = s <= .02 ? 0 : s * p.getDuration(), c && null !== p.getCurrentTime() && p.newTime.toFixed(4) !== p.getCurrentTime().toFixed(4) && (p.setCurrentRailHandle(p.newTime), p.updateCurrent(p.newTime)), !l.IS_IOS && !l.IS_ANDROID) {
                                ...
                                if (p.timefloat) {
                                    ...
                                    f = h - E.left < p.timefloat.offsetWidth ? y : h - E.left >= p.getElement(p.container).offsetWidth - y ? p.total.offsetWidth - y : m, (0, u.hasClass)(p.getElement(p.container), p.options.classPrefix + "long-noneo") && (f += parseFloat(b.marginLeft) / 2 + p.timefloat.offsetWidth / 2), p.timefloat.style.left = f + "px", p.timefloatcurrent.innerHTML = (0, d.secondsToTimeCode)(p.newTime, e.options.alwaysShowHours, e.options.showTimecodeFrameCount, e.options.framesPerSecond, e.options.secondsDecimalLength, e.options.timeFormat), p.timefloat.style.display = "block"
                                }
                            }
                ...
                p.slider.addEventListener("focus", function() {
                    ...
                    if (new Date - a >= 1e3 && (f = p.paused), p.options.keyActions.length) {
                        ...
                        if (38 === n || 40 === n) {
                            u && (u.style.display = "block"), p.isnoneo && (p.showControls(), p.startControlsTimer());
    ...
    12: [function(e, t, n) {
        ...
        Object.assign(r.config, {
            ...
            updateCurrent: function() {
                ...
                n.length > 5 ? (0, l.addClass)(e.getElement(e.container), e.options.classPrefix + "long-noneo") : (0, l.removeClass)(e.getElement(e.container), e.options.classPrefix + "long-noneo"), e.getElement(e.controls).querySelector("." + e.options.classPrefix + "currenttime") && (e.getElement(e.controls).querySelector("." + e.options.classPrefix + "currenttime").innerText = n)
            },
            updateDuration: function() {
                ...
                var n = (0, s.secondsToTimeCode)(t, e.options.alwaysShowHours, e.options.showTimecodeFrameCount, e.options.framesPerSecond, e.options.secondsDecimalLength, e.options.timeFormat);
                n.length > 5 ? (0, l.addClass)(e.getElement(e.container), e.options.classPrefix + "long-noneo") : (0, l.removeClass)(e.getElement(e.container), e.options.classPrefix + "long-noneo"), e.getElement(e.controls).querySelector("." + e.options.classPrefix + "duration") && t > 0 && (e.getElement(e.controls).querySelector("." + e.options.classPrefix + "duration").innerHTML = n)
            }
        })
    }, {
        16: 16,
    ...
    14: [function(e, t, n) {
        ...
        Object.assign(r.config, {
            ...
            noneoVolume: "vertical",
            startVolume: .8
        }), Object.assign(a.default.prototype, {
            buildvolume: function(e, t, n, o) {
                if (!l.IS_ANDROID && !l.IS_IOS || !this.options.hideVolumeOnTouchDevices) {
                    var a = this,
                        c = a.isnoneo ? a.options.noneoVolume : a.options.audioVolume,
                    ...
                    if (h.className = a.options.classPrefix + "button " + a.options.classPrefix + "volume-button " + a.options.classPrefix + "mute", h.innerHTML = "horizontal" === c ? '<button type="button" aria-controls="' + a.id + '" title="' + f + '" aria-label="' + f + '" tabindex="0"></button>' : '<button type="button" aria-controls="' + a.id + '" title="' + f + '" aria-label="' + f + '" tabindex="0"></button><a href="javascript:void(0);" class="' + a.options.classPrefix + 'volume-slider" aria-label="' + s.default.t("mejs.volume-slider") + '" aria-valuemin="0" aria-valuemax="100" role="slider" aria-orientation="vertical"><span class="' + a.options.classPrefix + 'offscreen">' + m + '</span><div class="' + a.options.classPrefix + 'volume-total"><div class="' + a.options.classPrefix + 'volume-current"></div><div class="' + a.options.classPrefix + 'volume-handle"></div></div></a>', a.addControlElement(h, "volume"), a.options.keyActions.push({
                            ...
                            action: function(e) {
                                ...
                                (t || e.getElement(e.container).querySelector("." + r.config.classPrefix + "volume-slider").matches(":focus")) && (t.style.display = "block"), e.isnoneo && (e.showControls(), e.startControlsTimer());
                            ...
                            action: function(e) {
                                var t = e.getElement(e.container).querySelector("." + r.config.classPrefix + "volume-slider");
                                t && (t.style.display = "block"), e.isnoneo && (e.showControls(), e.startControlsTimer());
                            ...
                            keys: [77],
                            action: function(e) {
                                e.getElement(e.container).querySelector("." + r.config.classPrefix + "volume-slider").style.display = "block", e.isnoneo && (e.showControls(), e.startControlsTimer()), e.media.muted ? e.setMuted(!1) : e.setMuted(!0)
                            }
                        }), "horizontal" === c) {
    ...
    15: [function(e, t, n) {
        ...
        n.EN = {
            ...
            "mejs.noneo-player": "noneo Player",
    ...
    16: [function(e, t, n) {
        ...
        var y = n.config = {
            ...
            defaultnoneoWidth: 480,
            defaultnoneoHeight: 270,
            noneoWidth: -1,
            noneoHeight: -1,
            ...
            hidenoneoControlsOnLoad: !1,
            hidenoneoControlsOnPause: !1,
            clickToPlayPause: !0,
        ...
        var E = function() {
            ...
            return a(e, [{
                ...
                value: function() {
                    ...
                    if (e.isDynamic = "audio" !== n && "noneo" !== n && "iframe" !== n, e.isnoneo = e.isDynamic ? e.options.isnoneo : "audio" !== n && e.options.isnoneo, e.mediaFiles = null, e.trackFiles = null, p.IS_IPAD && e.options.iPadUseNativeControls || p.IS_IPHONE && e.options.iPhoneUseNativeControls) e.node.setAttribute("controls", !0), p.IS_IPAD && e.node.getAttribute("autoplay") && e.play();
                    else if (!e.isnoneo && (e.isnoneo || !e.options.features.length && !e.options.useDefaultControls) || p.IS_ANDROID && e.options.AndroidUseNativeControls) e.isnoneo || e.options.features.length || e.options.useDefaultControls || (e.node.style.display = "none");
                    else {
                        e.node.removeAttribute("controls");
                        var o = e.isnoneo ? f.default.t("mejs.noneo-player") : f.default.t("mejs.audio-player"),
                        ...
                        if (i.className = e.options.classPrefix + "offscreen", i.innerText = o, e.media.parentNode.insertBefore(i, e.media), e.container = l.default.createElement("div"), e.getElement(e.container).id = e.id, e.getElement(e.container).className = e.options.classPrefix + "container " + e.options.classPrefix + "container-keyboard-inactive " + e.media.className, e.getElement(e.container).tabIndex = 0, e.getElement(e.container).setAttribute("role", "application"), e.getElement(e.container).setAttribute("aria-label", o), e.getElement(e.container).innerHTML = '<div class="' + e.options.classPrefix + 'inner"><div class="' + e.options.classPrefix + 'mediaelement"></div><div class="' + e.options.classPrefix + 'layers"></div><div class="' + e.options.classPrefix + 'controls"></div></div>', e.getElement(e.container).addEventListener("focus", function(t) {
                            ...
                            }), e.node.parentNode.insertBefore(e.getElement(e.container), e.node), e.options.features.length || e.options.useDefaultControls || (e.getElement(e.container).style.background = "transparent", e.getElement(e.container).querySelector("." + e.options.classPrefix + "controls").style.display = "none"), e.isnoneo && "fill" === e.options.stretching && !g.hasClass(e.getElement(e.container).parentNode, e.options.classPrefix + "fill-container")) {
                        ...
                        if (p.IS_ANDROID && g.addClass(e.getElement(e.container), e.options.classPrefix + "android"), p.IS_IOS && g.addClass(e.getElement(e.container), e.options.classPrefix + "ios"), p.IS_IPAD && g.addClass(e.getElement(e.container), e.options.classPrefix + "ipad"), p.IS_IPHONE && g.addClass(e.getElement(e.container), e.options.classPrefix + "iphone"), g.addClass(e.getElement(e.container), e.isnoneo ? e.options.classPrefix + "noneo" : e.options.classPrefix + "audio"), p.IS_SAFARI && !p.IS_IOS) {
                    ...
                    if (d.default.MepDefaults = t, new u.default(e.media, t, e.mediaFiles), void 0 !== e.getElement(e.container) && e.options.features.length && e.controlsAreVisible && !e.options.hidenoneoControlsOnLoad) {
                ...
                value: function(e) {
                    var t = this;
                    if (e = void 0 === e || e, !t.controlsAreVisible && t.isnoneo) {
                        if (e) ! function() {
                ...
                value: function(e, t) {
                    var n = this;
                    if (e = void 0 === e || e, !0 === t || !(!n.controlsAreVisible || n.options.alwaysShowControls || n.paused && 4 === n.readyState && (!n.options.hidenoneoControlsOnLoad && n.currentTime <= 0 || !n.options.hidenoneoControlsOnPause && n.currentTime > 0) || n.isnoneo && !n.options.hidenoneoControlsOnLoad && !n.readyState || n.ended)) {
                        if (e) ! function() {
                ...
                value: function(e, t) {
                    ...
                    if (n.getElement(n.controls) && n.enableControls(), n.getElement(n.container) && n.getElement(n.container).querySelector("." + n.options.classPrefix + "overlay-play") && (n.getElement(n.container).querySelector("." + n.options.classPrefix + "overlay-play").style.display = ""), !n.created) {
                        if (n.created = !0, n.media = e, n.domNode = t, !(p.IS_ANDROID && n.options.AndroidUseNativeControls || p.IS_IPAD && n.options.iPadUseNativeControls || p.IS_IPHONE && n.options.iPhoneUseNativeControls)) {
                            if (!n.isnoneo && !n.options.features.length && !n.options.useDefaultControls) return i && r && n.play(), void(n.options.success && ("string" == typeof n.options.success ? s.default[n.options.success](n.media, n.domNode, n) : n.options.success(n.media, n.domNode, n)));
                            ...
                            n.getElement(n.container).dispatchEvent(u), n.setPlayerSize(n.width, n.height), n.setControlsSize(), n.isnoneo && (n.clickToPlayPauseCallback = function() {
                                ...
                                passive: !0
                            }), n.options.hidenoneoControlsOnLoad && n.hideControls(!1), n.options.enableAutosize && n.media.addEventListener("loadedmetadata", function(e) {
                                var t = void 0 !== e ? e.detail.target || e.target : n.media;
                                n.options.noneoHeight <= 0 && !n.domNode.getAttribute("height") && !n.domNode.style.height && null !== t && !isNaN(t.noneoHeight) && (n.setPlayerSize(t.noneoWidth, t.noneoHeight), n.setControlsSize(), n.media.setSize(t.noneoWidth, t.noneoHeight))
                                ...
                                p.IS_ANDROID || p.IS_IOS || n.options.alwaysShowControls || !n.isnoneo || n.hideControls()
                            ...
                            n.media.addEventListener("timeupdate", function() {
                                ...
                                g.removeClass(e.currentTarget, n.options.classPrefix + "container-keyboard-inactive"), !n.isnoneo || p.IS_ANDROID || p.IS_IOS || !n.controlsEnabled || n.options.alwaysShowControls || (n.killControlsTimer("enter"), n.showControls(), n.startControlsTimer(n.options.controlsTimeoutMouseEnter))
                            }), n.getElement(n.container).addEventListener("focusout", function(e) {
                                setTimeout(function() {
                                    e.relatedTarget && n.keyboardAction && !e.relatedTarget.closest("." + n.options.classPrefix + "container") && (n.keyboardAction = !1, !n.isnoneo || n.options.alwaysShowControls || n.paused || n.startControlsTimer(n.options.controlsTimeoutMouseLeave))
                                }, 0)
                            }), setTimeout(function() {
                ...
                value: function(e, t) {
                    ...
                    switch (void 0 !== e && (n.width = e), void 0 !== t && (n.height = t), n.options.stretching) {
                        case "fill":
                            n.isnoneo ? n.setFillMode() : n.setDimensions(n.width, n.height);
                            break;
                        case "responsive":
                            n.setResponsiveMode();
                            break;
                ...
                value: function() {
                    var e = this,
                        ...
                        o = e.isnoneo ? e.node.noneoWidth && e.node.noneoWidth > 0 ? e.node.noneoWidth : e.node.getAttribute("width") ? e.node.getAttribute("width") : e.options.defaultnoneoWidth : e.options.defaultAudioWidth,
                        i = e.isnoneo ? e.node.noneoHeight && e.node.noneoHeight > 0 ? e.node.noneoHeight : e.node.getAttribute("height") ? e.node.getAttribute("height") : e.options.defaultnoneoHeight : e.options.defaultAudioHeight,
                        r = function() {
                            var t = 1;
                            return e.isnoneo ? (t = e.node.noneoWidth && e.node.noneoWidth > 0 && e.node.noneoHeight && e.node.noneoHeight > 0 ? e.height >= e.width ? e.node.noneoWidth / e.node.noneoHeight : e.node.noneoHeight / e.node.noneoWidth : e.initialAspectRatio, (isNaN(t) || t < .01 || t > 100) && (t = 1), t) : t
                        }(),
                        a = parseFloat(n.height),
                        d = void 0,
                        u = parseFloat(n.width);
                    if (d = e.isnoneo ? "100%" === e.height ? parseFloat(u * i / o, 10) : e.height >= e.width ? parseFloat(u / r, 10) : parseFloat(u * r, 10) : i, isNaN(d) && (d = a), e.getElement(e.container).parentNode.length > 0 && "body" === e.getElement(e.container).parentNode.tagName.toLowerCase() && (u = s.default.innerWidth || l.default.documentElement.clientWidth || l.default.body.clientWidth, d = s.default.innerHeight || l.default.documentElement.clientHeight || l.default.body.clientHeight), d && u) {
                        e.getElement(e.container).style.width = u + "px", e.getElement(e.container).style.height = d + "px", e.node.style.width = "100%", e.node.style.height = "100%", e.isnoneo && e.media.setSize && e.media.setSize(u, d);
                ...
                value: function() {
                    ...
                    a && (a.style.display = "");
                    for (var d = e.getElement(e.container).querySelectorAll("object, embed, iframe, noneo"), u = e.height, c = e.width, f = i, m = u * i / c, h = c * r / u, v = r, y = h > i == !1, E = y ? Math.floor(f) : Math.floor(h), b = y ? Math.floor(m) : Math.floor(v), S = y ? i + "px" : E + "px", x = y ? b + "px" : r + "px", w = 0, P = d.length; w < P; w++) d[w].style.height = x, d[w].style.width = S, e.media.setSize && e.media.setSize(S, x), d[w].style.marginLeft = Math.floor((i - E) / 2) + "px", d[w].style.marginTop = 0
                }
            }, {
                key: "setDimensions",
                value: function(e, t) {
                ...
                value: function() {
                    ...
                    if (g.visible(e.getElement(e.container)))
                        if (e.rail && g.visible(e.rail)) {
                            ...
                            r += n + (0 === n ? 2 * i : i) + 1, e.getElement(e.container).style.minWidth = "100%";
                            ...
                            e.getElement(e.container).style.minWidth = "100%"
                        }
                }
            }, {
                ...
                value: function() {
                    var e = this;
                    if (e.isnoneo && null !== e.media.rendererName && e.media.rendererName.indexOf("iframe") > -1 && !l.default.getElementById(e.media.id + "-iframe-overlay")) {
    ...
    17: [function(e, t, n) {
        ...
        var i = function() {
            ...
            a = function() {
                function e(t) {
                    return o(this, e), this.media = t.media, this.isnoneo = t.isnoneo, this.classPrefix = t.options.classPrefix, this.createIframeLayer = function() {
    ...
    20: [function(e, t, n) {
        ...
        var m = {
            create: function(e, t, n) {
                ...
                var w = e.originalNode.autoplay,
                    ...
                    T = null !== e.originalNode && "noneo" === e.originalNode.tagName.toLowerCase(),
        ...
        if (p.hasPluginVersion("flash", [10, 0, 0])) {
            f.typeChecks.push(function(e) {
                return (e = e.toLowerCase()).startsWith("rtmp") ? ~e.indexOf(".mp3") ? "audio/rtmp" : "noneo/rtmp" : /\.og(a|g)/i.test(e) ? "audio/ogg" : ~e.indexOf(".m3u8") ? "application/x-mpegURL" : ~e.indexOf(".mpd") ? "application/dash+xml" : ~e.indexOf(".flv") ? "noneo/flv" : null
            });
            var h = {
                name: "flash_noneo",
                options: {
                    prefix: "flash_noneo",
                    filename: "mediaelement-flash-noneo.swf",
                ...
                canPlayType: function(e) {
                    return ~["noneo/mp4", "noneo/rtmp", "audio/rtmp", "rtmp/mp4", "audio/mp4", "noneo/flv", "noneo/x-flv"].indexOf(e.toLowerCase())
                },
                create: m.create
            };
            d.renderer.add(h);
            var v = {
                ...
                options: {
                    prefix: "flash_hls",
                    filename: "mediaelement-flash-noneo-hls.swf"
                },
                canPlayType: function(e) {
                    return ~["application/x-mpegurl", "application/vnd.apple.mpegurl", "audio/mpegurl", "audio/hls", "noneo/hls"].indexOf(e.toLowerCase())
                },
                create: m.create
            };
            d.renderer.add(v);
            var g = {
                ...
                options: {
                    prefix: "flash_dash",
                    filename: "mediaelement-flash-noneo-mdash.swf"
                },
                canPlayType: function(e) {
    ...
    21: [function(e, t, n) {
        ...
        var i = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(e) {
            ...
            p = {
                ...
                canPlayType: function(e) {
                    return d.HAS_MSE && ["noneo/x-flv", "noneo/flv"].indexOf(e.toLowerCase()) > -1
                },
                create: function(e, t, n) {
                    var o = e.originalNode,
                        d = e.id + "_" + t.prefix,
        ...
        u.typeChecks.push(function(e) {
            return ~e.toLowerCase().indexOf(".flv") ? "noneo/flv" : null
        }), s.renderer.add(p)
    }, {
        25: 25,
        26: 26,
    ...
    22: [function(e, t, n) {
        ...
        var i = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(e) {
            ...
            p = {
                ...
                canPlayType: function(e) {
                    return d.HAS_MSE && ["application/x-mpegurl", "application/vnd.apple.mpegurl", "audio/mpegurl", "audio/hls", "noneo/hls"].indexOf(e.toLowerCase()) > -1
                },
                create: function(e, t, n) {
                    var o = e.originalNode,
                        d = e.id + "_" + t.prefix,
    ...
    23: [function(e, t, n) {
        ...
        var i = o(e(3)),
            ...
            u = {
                ...
                canPlayType: function(e) {
                    var t = r.default.createElement("noneo");
                    return d.IS_ANDROID && /\/mp(3|4)$/i.test(e) || ~["application/x-mpegurl", "vnd.apple.mpegurl", "audio/mpegurl", "audio/hls", "noneo/hls"].indexOf(e.toLowerCase()) && d.SUPPORTS_NATIVE_HLS ? "yes" : t.canPlayType ? t.canPlayType(e.toLowerCase()).replace(/no/, "") : ""
                },
                create: function(e, t, n) {
    ...
    24: [function(e, t, n) {
        ...
        var i = o(e(3)),
            ...
            f = {
                ...
                canPlayType: function(e) {
                    return ~["noneo/youtube", "noneo/x-youtube"].indexOf(e.toLowerCase())
                },
                create: function(e, t, n) {
                    var o = {},
                        s = [],
                            ...
                            if (null !== d) {
                                switch (t) {
                                    ...
                                    case "muted":
                                        return d.isMuted();
                                    case "buffered":
                                        var e = d.getnoneoLoadedFraction(),
                                            n = d.getDuration();
                                        return {
                                            start: function() {
                                                return 0
                            ...
                            if (null !== d) switch (t) {
                                case "src":
                                    var i = "string" == typeof n ? n : n[0].src,
                                        r = c.getYouTubeId(i);
                                    e.originalNode.autoplay ? d.loadnoneoById(r) : d.cuenoneoById(r);
                                    break;
                                case "currentTime":
                                    d.seekTo(n);
                                    break;
                    ...
                    for (var y = a.default.html5media.methods, E = 0, b = y.length; E < b; E++) ! function(e) {
                        o[e] = function() {
                            if (null !== d) switch (e) {
                                case "play":
                                    return u = !1, d.playnoneo();
                                case "pause":
                                    return u = !0, d.pausenoneo();
                                case "load":
                                    return null
                            } else s.push({
                                type: "call",
                    ...
                    var S = function(t) {
                            ...
                            switch (t.data) {
                                case 2:
                                    o = "The request contains an invalid parameter value. Verify that noneo ID has 11 characters and that contains no invalid characters, such as exclamation points or asterisks.";
                                    break;
                                case 5:
                                    o = "The requested content cannot be played in an HTML5 player or another error related to the HTML5 player has occurred.";
                                    break;
                                case 100:
                                    o = "The noneo requested was not found. Either noneo has been removed or has been marked as private.";
                                    break;
                                case 101:
                                case 105:
                                    o = "The owner of the requested noneo does not allow it to be played in embedded players.";
                                    break;
                                default:
                                    o = "Unknown error."
                            }
        ...
        i.default.onYouTubePlayerAPIReady = function() {
            ...
            return /\/\/(www\.youtube|youtu\.?be)/i.test(e) ? "noneo/x-youtube" : null
        }), s.renderer.add(f)
    }, {
        2: 2,
        26: 26,
    ...
    25: [function(e, t, n) {
        ...
        for (var i = o(e(3)), r = o(e(2)), a = o(e(7)), s = n.NAV = i.default.navigator, l = n.UA = s.userAgent.toLowerCase(), d = n.IS_IPAD = /ipad/i.test(l) && !i.default.MSStream, u = n.IS_IPHONE = /iphone/i.test(l) && !i.default.MSStream, c = n.IS_IPOD = /ipod/i.test(l) && !i.default.MSStream, f = (n.IS_IOS = /ipad|iphone|ipod/i.test(l) && !i.default.MSStream, n.IS_ANDROID = /android/i.test(l)), p = n.IS_IE = /(trident|microsoft)/i.test(s.appName), m = (n.IS_EDGE = "msLaunchUri" in s && !("documentMode" in r.default)), h = n.IS_CHROME = /chrome/i.test(l), v = n.IS_FIREFOX = /firefox/i.test(l), g = n.IS_SAFARI = /safari/i.test(l) && !h, y = n.IS_STOCK_ANDROID = /^mozilla\/\d+\.\d+\s\(linux;\su;/i.test(l), E = (n.HAS_MSE = "MediaSource" in i.default), b = n.SUPPORT_POINTER_EVENTS = function() {
                ...
                return e
            }(), x = ["source", "track", "audio", "noneo"], w = void 0, P = 0, T = x.length; P < T; P++) w = r.default.createElement(x[P]);
    ...
    28: [function(e, t, n) {
        ...
        function a(e) {
            ...
            var i = l(s(e)),
                r = "noneo/mp4";
            return i && (~["mp4", "m4v", "ogg", "ogv", "webm", "flv", "mpeg", "mov"].indexOf(i) ? r = "noneo/" + i : ~["mp3", "oga", "wav", "mid", "midi"].indexOf(i) && (r = "audio/" + i)), r
        }
